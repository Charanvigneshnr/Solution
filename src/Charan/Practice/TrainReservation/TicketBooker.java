package Charan.Practice.TrainReservation;
...
public class TicketBooker {
    ...
    static List<Integer> lowerBerthsPositions = new ArrayList<>(List.of(1));//normally 1,2,...21
    static List<Integer> middleBerthsPositions = new ArrayList<>(List.of(1));//normally 1,2,...21
    static List<Integer> upperBerthsPositions = new ArrayList<>(List.of(1));//normally 1,2,...21
    static List<Integer> racPositions = new ArrayList<>(List.of(1));//normally 1,2,...18
    static List<Integer> waitingListPositions = new ArrayList<>(List.of(1));//normally 1,2,...10
